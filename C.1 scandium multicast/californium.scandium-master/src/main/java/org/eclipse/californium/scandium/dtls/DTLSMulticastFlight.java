 ...
 * details.
 */
public class DTLSMulticastFlight {

	/**
	 * The DTLS messages that belong to this flight and need to be sent, when
	 * the timeout expires.
	 */
	private List<RecordMulticast> messages;
	 ...
	 */
	public DTLSMulticastFlight() {
		this.messages = new ArrayList<RecordMulticast>();
		this.tries = 0;
		this.timeout = 0;
	}
	
	public void addMessage(List<RecordMulticast> message) {
		messages.addAll(message);
	}

	public void addMessage(RecordMulticast message) {
		messages.add(message);
	}

	public List<RecordMulticast> getMessages() {
		return messages;
	}
	...
	public void setSession(DTLSMulticastSession session) {
