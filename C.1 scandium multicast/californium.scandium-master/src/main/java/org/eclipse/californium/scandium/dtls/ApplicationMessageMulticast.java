 ...
 */
public class ApplicationMessageMulticast implements DTLSMulticastMessage {
	 ...
	 */
	public ApplicationMessageMulticast(byte[] data) {
		this.data = data;
	}
	...
	public static DTLSMulticastMessage fromByteArray(byte[] byteArray) {
		return new ApplicationMessageMulticast(byteArray);
	}
